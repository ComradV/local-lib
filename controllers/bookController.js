...
exports.book_detail = function(req, res, next) {
    async.parallel({
      ...
      testbook = {}
	  //Successful, so render
      res.render('book_detail', { book: results.book, bookinstances: results.bookinstances});
    });
};
...
exports.book_delete_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        // Successful, so render.
        res.render('book_delete', { title: 'Delete Book', book: results.book, copies: results.copies } );
    });
};
...
exports.book_delete_post = function(req, res, next) {
    ...
    async.parallel({
        ...
        if (err) { return next(err); }
		if (results.copies.length > 0) {//Can't delete
			res.render('book_delete', { title: 'Delete Book', book: results.book, copies: results.copies } );
		}
		else{
